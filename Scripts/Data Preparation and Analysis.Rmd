...
gpt2_plot = conditional_effects(m4, plot = F, effects = "CenteredLogOverallFreq:RelFreq", int_conditions=list(RelFreq = c(-0.25, 0, 0.25)))
...
ggarrange(gpt2, gpt2xl, olmo1b, olmo7b, llama2, nrow=3, widths = c(0.5, 1)))
